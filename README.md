About r-argumentcheck-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-argumentcheck-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3329&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-argumentcheck-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-argumentcheck` can be installed with `conda`:
...
```
mamba install r-argumentcheck
```

It is possible to list all of the versions of `r-argumentcheck` available on your platform with `conda`:
...
```
mamba search r-argumentcheck --channel conda-forge
```
...
mamba repoquery search r-argumentcheck --channel conda-forge

# List packages depending on `r-argumentcheck`:
mamba repoquery whoneeds r-argumentcheck --channel conda-forge

# List dependencies of `r-argumentcheck`:
mamba repoquery depends r-argumentcheck --channel conda-forge
```
